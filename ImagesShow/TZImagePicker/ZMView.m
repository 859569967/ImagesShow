...
-(NSString*) saveImageToLocalimage:(UIImage*)image filename:(NSString*)filename index:(int)index{
    ...
    NSString *fullPath = [NSString stringWithFormat:@"%@/%@",ApplicationDelegate.folderPath,filename];
...
-(NSString*)getChatFilePathIgnoreSame:(NSString*)name{
    ...
    NSMutableString* path = [[NSMutableString alloc]initWithString:documentDirectory];
    [path appendString:@"//"];
